...
let joe = new Student('Joe', '50', 'Michigan');
...
// };
Student.prototype.greeting = () => `Hi, my name is ${this.name}joe`;
// TODO: Uncomment the following line of code to see the output in the browser console
...
// this is name age hometown
// 2. What is "this" when joe.scopeArrow() is invoked?
// window, self, document, name, locaiton
// 3. Explain why "this" is different when an arrow function is used.
// Because constructors act diffrent with arrows